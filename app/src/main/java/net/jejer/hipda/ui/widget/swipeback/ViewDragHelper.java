...
public class ViewDragHelper {
     ...
     * callback's
     * {@link ViewDragHelper.Callback#onEdgeTouched()}
     * and
     * {@link ViewDragHelper.Callback#onEdgeDragStarted()}
     ...
     * {@link ViewDragHelper.Callback#tryCaptureView(int)}
     ...
     */
    public void smoothSlideViewTo(View child, int finalLeft, int finalTop) {
        mCapturedView = child;
        mActivePointerId = INVALID_POINTER;

        forceSettleCapturedViewAt(finalLeft, finalTop, 0, 0);
    }
     ...
     */
    private void forceSettleCapturedViewAt(int finalLeft, int finalTop, int xvel, int yvel) {
    ...
    private int computeSettleDuration(int dx, int dy, int xvel, int yvel) {
        ...
        int yduration = computeAxisDuration(dy, yvel, mCallback.getViewVerticalDragRange());
    ...
    private boolean checkTouchSlop(View child, float dx, float dy) {
        ...
        final boolean checkVertical = mCallback.getViewVerticalDragRange() > 0;
    ...
    private void dragTo(int left, int top, int dx, int dy) {
        ...
        if (dx != 0) {
            clampedX = mCallback.clampViewPositionHorizontal(mCapturedView, left);
    ...
    public static abstract class Callback {
         ...
         */
        public abstract boolean tryCaptureView(int pointerId);
